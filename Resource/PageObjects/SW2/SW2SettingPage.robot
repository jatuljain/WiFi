...
${SWP2_Image}  css=img[src='images/ap_80_swp2.png']
${SWP1_Image}  css=img[src='images/ap_80_swp1.png']
${ExperiaWiFi_Image}  css=img[src='images/ap_80_swp1.png']
${V10A_Image}  css=img[src='images/owl/Experia_Box_owl.png?ver=1626255583']
${V10_Image}  css=img[src='images/rootap_80.png']
