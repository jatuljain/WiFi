...
${Device_Mac_Address_5GRE}  //td[normalize-space()='5G RE']//preceding::td[1]  
...
Get the MAC Address of WiFi Connected Devices list
    ...
    @{Mac_Address_WebElement5REGhz}=  Get WebElements   ${Device_Mac_Address_5GRE}
    ...
    @{Mac_Address_WebElement}=  Combine Lists  ${Mac_Address_WebElement5Ghz}  ${Mac_Address_WebElement24Ghz}  ${Mac_Address_WebElement5REGhz}
